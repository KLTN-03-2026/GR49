...
public class MomoService {
    ...
    private static final String REDIRECT_URL = "http://localhost:8080/api/payment/momo-pay-callback";;
    private static final String IPN_URL = "http://localhost:8080/api/payment/momo-pay-callback";
    // private static final String REQUEST_TYPE = "captureWallet";
    private static final String REQUEST_TYPE = "payWithMethod";
    private final MomoApi momoApi;

    public CreateMomoResponse createQR(ThanhToanDonHangRequestDto dto) {
